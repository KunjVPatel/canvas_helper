...
// Add message to screen with optional duration and styling
...
function addWarning(msg, self_remove = true, add_class = '') {
    const duration = self_remove ? 7 : 0;
...
function howNuggetsWork() {
    const explanation = 
        `<p>Choose a topic for daily personalized lessons.</p>
         <p>One active topic at a time.</p>
         <p>Generated by your active AI model.</p>`;
